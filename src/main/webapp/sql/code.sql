...
create table if not exists Utenti (
    ...
    Username varchar(50) not null, -- forse bisogna mettere unique
...
insert into Utenti values
    (1, "pippo", "pippoBaudo@gmail.com", "e84f4e48108eff77de464b7897c414d6d06739e7"); -- password: pippoBaudo

insert into Prodotti values
                         (1, "Maglia Milan Home 23/24", 99.99, "Maglia", "Milan", "Puma", "Serie A 23/24"),
                         (2, "Maglia Napoli Home 23/24", 89.99, "Maglia", "Napoli", "Giorgio Armani", "Serie A 23/24");
...
insert into Ordini(ID_Ordine, Utente, Prodotto, Taglia, Quantita) values
                                                                      (1, 1, 1, "L", 2), (1, 1, 2, "L", 1);drop database if exists projectus;
create database if not exists projectus;
